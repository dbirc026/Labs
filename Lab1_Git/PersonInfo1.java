public class PersonInfo1 {
    ...
    public static String firstName = "Mohamed Reda";
    public static String lastName = "Ben Taleb";
    public static int studentNo = 300043376;
    public static String description = "That can only be me";
